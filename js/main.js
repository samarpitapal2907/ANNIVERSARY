document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkDateParts(enteredPassword) {
        ...
        dateCheck.innerHTML = `
            <p><strong>Your date check:</strong></p>
            <p>Day (${enteredDay}): ${dayResult}</p>
            <p>Month (${enteredMonth}): ${monthResult}</p>
            <p>Year (${enteredYear}): ${yearResult}</p>
        `;
    }
    ...
    const albumButton =
        document.getElementById("album-button");
    ...
    if (boyfriendTestButton) {
        boyfriendTestButton.addEventListener(
            ...
            function () {
                ...
                showScreen(boyfriendTestScreen);
            }
        );
    }
